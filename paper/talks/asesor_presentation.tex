...
% =============================================================================
\section{Narrativas pre-registradas}
% =============================================================================

% --- Slide 17: Cuatro narrativas (movido antes de Resultados) ---------------
\begin{frame}{Cuatro narrativas precomprometidas \emph{ex ante}}
  Antes de mirar el dato post-tratamiento, comprometí cuatro narrativas. Para cada país, una resultará compatible:
  \vfill
  \small
  \begin{itemize}
    \setlength\itemsep{0.45em}
    ...
    \item[\textbf{C.}] \textbf{Nulo en formal, grande en informal:} $\tau_F^c \approx 0$, $\tau_I^c$ negativo y significativo.
  ...
  \vfill
  \normalsize
  \textbf{Compromiso:} la narrativa enfatizada queda determinada por el patrón observado, no por búsqueda \emph{ex post}. \emph{Adelanto: en Perú, ninguna encajó --- volveré a este punto en la síntesis.}
\end{frame}
...
\begin{frame}{Síntesis -- ninguna de las cuatro narrativas pre-registradas encaja}
  ...
  \vfill
  \normalsize
  El Patrón P se añadirá al pre-registro de OSF antes de mirar el dato post-tratamiento de los cinco países restantes. El pre-registro del análisis por formalidad de línea base como margen central queda vindicado; el mapeo a una narrativa específica queda como hipótesis a contrastar fuera de Lima.
\end{frame}
