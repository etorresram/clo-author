...
\begin{frame}{Datos: seis países, 2021T1--2025T4}
  ...
  Perú       & EPEN      & Trimestral      & Lima Metropolitana \\
  ...
  \textbf{Caveat de Perú:} la ENAHO descontinuó el módulo trimestral de empleo en 2023; la EPEN solo cubre Lima Metropolitana, por lo que $\hat\tau^{Per\acute{u}}$ se interpreta como Lima-específico, no nacionalmente representativo.
\end{frame}
...
\begin{frame}{Preguntas para discutir}
  \begin{enumerate}
    ...
    \item \textbf{Caveat de Perú:} ¿incluir Perú con representatividad solo de Lima, o relegarlo a robustez? La justificación está en el diseño de la EPEN.
