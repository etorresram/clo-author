...
\setbeamertemplate{title page}{%
  ...
  {\titlefont\huge\color{pdark}\inserttitle\par}
  \endgroup
  \vspace{0.45em}
...
\newcommand{\weak}[1]{%
  ...
  \begin{minipage}{0.95\linewidth}
    ...
    \colorbox{paccent!8}{%
      \begin{minipage}{\dimexpr\linewidth-1.4em}%
        {\color{paccent}\textbf{Punto débil.}} \color{pdark}#1%
      \end{minipage}%
    }%
  \end{minipage}
  \end{center}
...
\textbf{B.} Replicación del nulo & $|\hat\tau^c|$ pequeño y nulo en ambos canales. Perú/ALC = Dinamarca \cit{HV 2025a}. \\[0.3em]
...
\textbf{Perú} & \textbf{EPEN} & \textbf{Trimestral, solo Lima Metro} & \textbf{CO-1995 $\to$ CNO-2015 $\to$ CIUO-08} \\
...
\begin{frame}{Puntos débiles (I): identificación y datos}
\footnotesize
\vspace{0.2em}
...
\begin{frame}{Puntos débiles (II): supuestos y método}
\footnotesize
\vspace{0.2em}
\begin{enumerate}\setlength\itemsep{0.35em}
  \setcounter{enumi}{4}
